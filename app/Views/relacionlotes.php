<!-- app/Views/relacionlotes.php -->

<!-- Visualizar lo Relacionado con Lotes -->
...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4 text-dark">Relacionado con Lotes</h1>
    <div class="row justify-content-center">

        <?php
            $relacionados = [
                ["Tipo de Compra", "tiposcompras"],
                ["Procedencia", "procedencias"],
                ["Entrada de Lotes", "lotes"]
            ];
        ?>
