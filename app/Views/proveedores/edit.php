<!-- app/Views/proveedores/edit.php -->

<!-- Vista para la edición de un Proveedor -->
...
<body style="background-color: #9AB5D9;">
    <div class="container mt-5">
        ...
        <form action="<?= base_url('proveedores/update/'.$proveedor['ID_PROVEEDOR']) ?>" method="POST">
            <div class="parent">
                ...
                <div class="div2">
                    ...
                    <input type="number" class="form-control" id="CONTACTO_PROVEEDOR" name="CONTACTO_PROVEEDOR" value="<?= $proveedor['CONTACTO_PROVEEDOR'] ?>" required>
                </div>

                <!-- Campo para el correo electrónico del proveedor -->
                <div class="div3">
                    <label for="CORREO_PROVEEDOR" class="form-label">Correo Electrónico</label>
                    <input type="text" class="form-control" id="CORREO_PROVEEDOR" name="CORREO_PROVEEDOR" value="<?= $proveedor['CORREO_PROVEEDOR'] ?>">
                </div>
                ...
                <div class="div4">
                    ...
                    <select class="form-control" id="ESTADO_PROVEEDOR" name="ESTADO_PROVEEDOR" required>
                        <option value="1" <?= $proveedor['ESTADO_PROVEEDOR'] == 'Activo' ? 'selected' : '' ?>>Activo</option>
                        <option value="0" <?= $proveedor['ESTADO_PROVEEDOR'] == 'Inactivo' ? 'selected' : '' ?>>Inactivo</option>
                    </select>
                </div>
            </div>
